...
We are pleased to introduce an updated version of our XGR software, which has gained increasing popularity in genomics research since its first release (see [Genome Medicine 2016](https://www.ncbi.nlm.nih.gov/pubmed/27964755)). This update features a newly designed web server, called XGR Plus or XGR+, now made available [here](http://www.genomicsummary.pro/XGRplus) to all users for free and without any login requirements. It enables almost real-time enrichment and subnetwork analyses for user-input lists of genes, SNPs, genomic regions, or protein domains, leveraging ontologies, networks, and many other knowledgebase resources, such as e/pQTL, promoter capture Hi-C, and enhancer-gene maps.
