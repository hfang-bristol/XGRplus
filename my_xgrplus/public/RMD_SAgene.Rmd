...
> **An interactive table** for the subnetwork genes (n=`r ls_rmd$vcount`), with the column `Pvalue` for input gene significance information. Each gene listed in the column `Genes` is hyperlinked to its corresponding [GeneCards](https://www.genecards.org) page.
