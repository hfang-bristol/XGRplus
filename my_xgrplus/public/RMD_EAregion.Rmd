...
rmarkdown::render("now.RMD_EAregion.Rmd", bookdown::html_document2(number_sections=F,theme=c("readable","united")[2], hightlight="default"), output_dir="/Users/hfang/Sites/XGR/XGRplus-site/app/examples")
...
> **An interactive table** that displays enriched ontology terms based on `r ls_rmd$num_LG` linked genes. Each enriched term (the columns `Ontology`, `Term ID` and `Term Name`) has the enrichment z-score (`Z-score`), the enrichment significance level (`FDR`), the number (`Num`) and list (`Members`) of member genes that overlap with linked genes.
...
```{r}
#hlink_pdf <- oAuxEmbed("~Sites/XGR/XGRplus-site/app/examples/EAregion_enrichment_forestplot.pdf", link.text="Download PDF")
...
library(png)
library(grid)
#filename <- str_c('"~Sites/XGR/XGRplus-site/app/examples/EAregion_enrichment_forestplot.png')
...
```{r}
#hlink_pdf <- oAuxEmbed("~Sites/XGR/XGRplus-site/app/examples/EAregion_enrichment_dotplot.pdf", link.text="Download PDF")
...
library(png)
library(grid)
#filename <- str_c('~Sites/XGR/XGRplus-site/app/examples/EAregion_enrichment_dotplot.png')
